const UNSPLASH_ACCESS_KEY = 'sMpFaPOhhWCW1UdaqRfcf6fd09P-Zwc1GPJtL4wZUFE';
...
async function getRandomPhoto() {
  ...
  let endpoint = 'https://api.unsplash.com/photos/random?orientation=landscape&query=harry potter';
